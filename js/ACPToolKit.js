var ACPToolKit = (function () {
    ...
    if (window.location.pathname.indexOf('experiment') > -1) {
        ...
        module.presentTrial = function (options) {
            ...
            var iface = new AutoComPaste.Interface(wm, engine, data_file, stimuli, numOfWindows);
